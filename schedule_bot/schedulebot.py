...
from kb import ikb_group, ikb_wd, ikb_days, ikb_changeweek, \
    ...
    ikb_setday, ikb_choose_to_change, ikb_change_lectsub, ikb_group_modify, \
    ikb_week_modify, ikb_day_modify, ikb_which_change, ikb_group_delete, ikb_week_delete, ikb_day_delete, \
    ikb_modify_from_add, ikb_add_from_modify
import logging
import datetime
